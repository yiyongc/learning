...
func Template(w http.ResponseWriter, r *http.Request, tmpl string, td *models.TemplateData) error {
	...
	_ = t.Execute(buf, td) // write the bytes of the template into the buffer
...
// CreateTemplateCache create a cache of templates as a map after parsing templates folder
